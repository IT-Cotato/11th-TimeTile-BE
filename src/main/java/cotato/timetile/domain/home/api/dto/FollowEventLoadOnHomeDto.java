...
public record FollowEventLoadOnHomeDto(
        Long eventId,
        String groupId,
        String name,
        String description,
    ...
    public static FollowEventLoadOnHomeDto of(Event event, List<RelatedEventDto> relatedEvents) {
        return new FollowEventLoadOnHomeDto(
                event.getId(),
                event.getGroupId(),
                event.getName(),
